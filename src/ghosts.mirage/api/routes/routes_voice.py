...
from config.config import SYNTHESIS_ENABLED
...
# Function to filter only dialogue lines from the generated script
...
def generate_synthesised_conversation(
    ...
    conversation_script = generate_document_with_ollama(prompt, model=model)
