...
- **Content**: Provides a richer array of content for the documents created by NPCs.
...
1. **Create and Run Content Model**:
...
Now Ollama is running all four models concurrently. The API server provides access to each model.
